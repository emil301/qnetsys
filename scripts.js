...
function showServiceDetail(id) {
  ...
  overlay.innerHTML = `
    <div class="glass-card rounded-2xl max-w-lg w-full p-8 relative" style="animation:fadeInUp .3s ease-out both">
...
7. FORMULARIO DE CONTACTO
---------------------------------------------------------------- */
const WEB3FORMS_KEY = '0c1a9752-32a9-4f51-8348-e821ace6775d';
...
});   // ← cierre del DOMContentLoaded del formulario
...
// Keyframe fadeInUp para el modal
